...
void Mesh::setup(const ci::geom::Source &source, ci::Color color, ci::gl::GlslProgRef mGlsl, ci::vec3 pos, ci::vec3 rot,ci::vec3 scale)
{
...
void Mesh::setup(TriMeshRef mMesh,   ci::Color color, ci::gl::GlslProgRef mGlsl, ci::vec3 pos, ci::vec3 rot,ci::vec3 scale)
{
